...
# 변경
file_path = 'C:/Users/minsoo/OneDrive - 창원대학교/바탕 화면/~~~_location.txt'
data_to_save = []
...
# CSV 파일로 저장 - 변경
with open('C:/Users/minsoo/OneDrive - 창원대학교/바탕 화면/geocoded_addresses_~~~.csv', 'w', newline='', encoding='utf-8') as csvfile:
