...
url = f'https://apis.openapi.sk.com/tmap/routes/pedestrian?version=1&format=json&appKey={tmap_api_key}&startX={start_lng}&startY={start_lat}&startName=출발지&passList={stopover_lng},{stopover_lat}&endX={end_lng}&endY={end_lat}&endName=목적지&searchOption=4'
